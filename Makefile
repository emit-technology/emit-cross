...
build:
	...
	cd cmd/cross && env GOARCH=amd64 go build -o ../../build/cross

cross-linux-amd64:
	sh ./scripts/cross-compile.sh linux/amd64

cross-darwin-amd64:
	sh ./scripts/cross-compile.sh darwin/amd64


install:
	@echo "  >  \033[32mInstalling bridge...\033[0m "
	cd cmd/cross && go install

build-mkdocs:
	docker run --rm -it -v ${PWD}:/docs squidfunk/mkdocs-material build

rebuild-eth-contracts:
